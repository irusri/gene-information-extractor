package preload
{
	...
	public class WelcomeScreen extends Loader
	{
		...
		[ Embed(source="welcomes.png", mimeType="application/octet-stream") ]
		public var WelcomeScreenGraphic:Class;
		public var timer:Timer;
		private var fadeInRate:Number  = .06;
		private var fadeOutRate:Number = .06;
		private var timeAutoClose:int = 2;
